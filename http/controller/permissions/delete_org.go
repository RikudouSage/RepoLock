...
func (receiver *Controller) DeleteUserOrganizationPermission(writer http.ResponseWriter, request *http.Request) {
	...
	if err = receiver.orgPermissionManager.RemoveMembership(request.Context(), membership); err != nil {
		receiver.writer.WriteErrorResponse(err, writer)
		return
	}
